...
export const Auth = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-x-clip bg-bg">
      ...
      />
      <Nav />
      <main className="relative z-10 flex-1 mx-auto w-full max-w-[1320px] 2xl:max-w-[1500px] 3xl:max-w-[92vw] 4xl:max-w-[94vw] px-4 sm:px-6 md:px-8 lg:px-12 pt-10 md:pt-14 pb-12 md:pb-16">
        <Reveal as="div">
          <PageMasthead
