...
export const Auth = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-x-clip bg-bg">
      ...
      />
      <Nav />
      <main className="relative z-10 flex-1 mx-auto w-full max-w-[1320px] 2xl:max-w-[1500px] 3xl:max-w-[2360px] 4xl:max-w-[3300px] px-4 sm:px-6 md:px-8 lg:px-12 pt-10 md:pt-14 pb-12 md:pb-16">
        <Reveal as="div">
          <PageMasthead
          ...
          <Reveal as="div" className="lg:col-span-7 3xl:col-span-8">
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="flex w-full flex-col sm:flex-row items-stretch ring-1 ring-line focus-within:ring-accent transition-shadow">
                ...
                <button
                  type="submit"
                  className="press shrink-0 whitespace-nowrap px-6 md:px-8 py-3.5 sm:py-0 font-sans text-[14px] md:text-[14.5px] font-bold tracking-[0.02em] uppercase text-bg bg-ink hover:bg-accent transition-colors border-0 cursor-pointer"
                >
                  Authenticate
                </button>
              </div>
