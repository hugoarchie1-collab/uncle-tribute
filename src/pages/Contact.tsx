    ...
    <div className="relative min-h-screen flex flex-col overflow-x-clip">
      ...
      <main className="relative z-10 flex-1 mx-auto w-full max-w-[1320px] 2xl:max-w-[1500px] 3xl:max-w-[1760px] 4xl:max-w-[2040px] px-4 sm:px-6 md:px-8 lg:px-12 pt-12 md:pt-14 pb-10 md:pb-14">
        ...
        <section className="mt-7 md:mt-9 lg:grid lg:grid-cols-12 lg:gap-x-12 xl:gap-x-16 items-start">
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                  <label className="group block">
                    ...
                    <input
                      ...
                      required
                      autoComplete="name"
                      className="w-full bg-[rgba(8,7,6,0.55)] ring-1 ring-line focus:ring-2 focus:ring-accent focus:outline-none px-5 py-4 font-sans text-[16px] md:text-[clamp(16px,0.9vw,20px)] text-ink placeholder:text-ink-fade transition-shadow"
                ...
                <label className="group block mb-4">
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full bg-[rgba(8,7,6,0.55)] ring-1 ring-line focus:ring-2 focus:ring-accent focus:outline-none px-5 py-4 font-sans text-[16px] md:text-[clamp(16px,0.9vw,20px)] leading-[1.65] text-ink placeholder:text-ink-fade transition-shadow resize-none"
          ...
          <Reveal as="div" delay={0.08} className="mt-10 lg:mt-0 lg:col-span-4 lg:col-start-9">
            <p className={cn(EYEBROW, "m-0 mb-4 md:mb-5")} style={{ textShadow: "0 2px 12px rgba(0,0,0,0.85)" }}>
              The estate
            </p>
