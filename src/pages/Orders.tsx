        ...
        <div className="mt-7 md:mt-9 grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-10 items-start border-t border-line pt-6 md:pt-8">
          ...
          <Reveal as="div" delay={0.06} className="lg:col-span-5">
            ...
            <a
              ...
              className="inline-flex items-center mt-6 px-6 py-3.5 ring-1 ring-line hover:ring-accent hover:text-accent transition-colors font-sans text-[11px] font-bold tracking-[0.18em] uppercase text-ink rounded-full"
            >
