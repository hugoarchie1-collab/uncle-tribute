...
export const Orders = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-x-clip">
      <SceneBackdrop src="/img/scenes/orders-autumn-scene-v4.webp" />
      <Nav />
      <main className="relative z-10 flex-1 mx-auto w-full max-w-[1320px] 2xl:max-w-[1500px] 3xl:max-w-[2360px] 4xl:max-w-[3300px] px-4 sm:px-6 md:px-8 lg:px-12 pt-10 md:pt-12 pb-14 md:pb-20">
        <Reveal>
          <PageMasthead
        ...
        <div className="mt-8 md:mt-10 grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-10 items-start border-t border-line pt-8 md:pt-10">
          ...
          <Reveal as="div" className="lg:col-span-7">
            <form onSubmit={onSubmit} noValidate>
              ...
              <div className="flex w-full items-stretch ring-1 ring-line focus-within:ring-accent transition-shadow">
                ...
                <button
                  type="submit"
                  className="shrink-0 whitespace-nowrap px-5 md:px-7 font-sans text-[14.5px] font-bold tracking-[0.02em] text-ink-muted hover:text-accent transition-colors bg-transparent border-0 border-l border-line cursor-pointer"
                >
                  Track
                </button>
              </div>
          ...
          <Reveal as="div" delay={0.06} className="lg:col-span-5 lg:border-l lg:border-line lg:pl-10">
            ...
            <a
              ...
              className="inline-flex items-center mt-6 px-6 py-3.5 ring-1 ring-line hover:ring-accent hover:text-accent transition-colors font-sans text-[14.5px] font-bold tracking-[0.02em] text-ink rounded-full"
            >
