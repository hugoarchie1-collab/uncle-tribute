  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-x-clip">
      ...
      {/* Canonical centred envelope (1320/1500/1720/1880) — the SAME axis +
          ...
          properly"). */}
      <main className="relative z-10 flex-1 mx-auto w-full max-w-[1320px] 2xl:max-w-[1500px] 3xl:max-w-[2360px] 4xl:max-w-[3300px] px-4 sm:px-6 md:px-8 lg:px-12 pt-10 md:pt-12 pb-10 md:pb-12">
        {/* ── MASTHEAD ─────────────────────────────────────────────────────
                ...
                <label className="block mt-4 max-w-[280px] 3xl:max-w-[340px]">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-bg-soft/85 ring-1 ring-line focus:ring-2 focus:ring-accent focus:outline-none pl-8 pr-4 py-3 font-sans text-[16px] 3xl:text-[22px] 4xl:text-[26px] text-ink placeholder:text-ink-fade transition-shadow [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
