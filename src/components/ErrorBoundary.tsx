...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render(): ReactNode {
    ...
    return (
      ...
      >
        <p className="font-sans text-[11px] font-bold uppercase tracking-[0.32em] text-ink/55">
        ...
        <div className="mt-2 flex flex-wrap items-center justify-center gap-4">
          <button
            ...
            className="press inline-flex items-center justify-center rounded-full bg-ink px-7 py-3 font-sans text-[12px] font-bold uppercase tracking-[0.18em] text-bg transition-colors hover:bg-accent"
          >
            Reload the page
          </button>
          <a
            href="/"
            className="font-sans text-[12px] font-bold uppercase tracking-[0.18em] text-ink/55 transition-colors hover:text-ink"
          >
            Return home
          </a>
        </div>
