    ...
    >
      <div className="pointer-events-auto flex items-center gap-3 sm:gap-4 rounded-full border border-line bg-[#0a0908]/95 px-5 py-3 shadow-[0_18px_40px_-20px_rgba(0,0,0,0.9)]">
        ...
        <button
          ...
          className="shrink-0 rounded-full bg-accent px-4 py-1.5 font-sans text-[14px] font-bold tracking-[0.04em] text-bg transition-opacity duration-300 hover:opacity-90"
        >
          Refresh
        </button>
        <button
