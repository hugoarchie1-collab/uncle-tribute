...
export const EYEBROW =
  "font-sans text-[13px] md:text-[15px] font-bold tracking-[0.14em] text-accent";
 ...
 *  sentence-case. */
export const TITLE =
  "font-display font-bold [font-variation-settings:'opsz'_48,'wght'_700] tracking-[-0.04em] text-[clamp(52px,8.2vw,92px)] leading-[1.02] md:leading-[0.97] text-ink text-balance";
...
export const EYEBROW_MUTED =
  "font-sans text-[13px] md:text-[15px] font-bold tracking-[0.04em] text-ink-muted";
