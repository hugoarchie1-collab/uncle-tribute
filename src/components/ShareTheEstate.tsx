    ...
    <div className={`mt-10 ${wrapAlign}`}>
      ...
      <div className={`flex flex-wrap items-center gap-2.5 ${rowAlign}`}>
        <button
          type="button"
          onClick={copy}
          className="inline-flex items-center font-sans text-[13px] font-bold tracking-[0.04em] text-ink/75 hover:text-accent ring-1 ring-white/15 hover:ring-accent transition-all px-4 py-2.5 bg-transparent border-0 cursor-pointer"
        >
          {copied ? "Link copied" : "Copy link"}
        </button>
        <a
          href={emailHref}
          className="inline-flex items-center font-sans text-[13px] font-bold tracking-[0.04em] text-ink/75 hover:text-accent ring-1 ring-white/15 hover:ring-accent transition-all px-4 py-2.5 no-underline"
        >
          Email
        </a>
        <a
