        ...
        >
          ...
          <span className="flex items-center gap-2 sm:gap-2.5 min-w-0">
            <img
              ...
              width={48}
              height={48}
              className="h-[38px] w-[38px] sm:h-[46px] sm:w-[46px] shrink-0 object-contain"
              style={{ filter: "drop-shadow(0 1px 4px rgba(0,0,0,0.6))" }}
            />
            <span
              className="font-display font-bold text-ink tracking-[-0.02em] leading-none whitespace-nowrap text-[clamp(18px,1.9vw,30px)] [text-shadow:0_1px_6px_rgba(0,0,0,0.55)]"
