  ...
  return (
    <figure className="m-0">
      ...
      >
        ...
        <text x={doorX + doorW / 2} y={doorY - 12} textAnchor="middle" fill="currentColor" className="text-ink/45" style={{ font: "600 11px Inter, sans-serif", letterSpacing: "0.14em", textTransform: "uppercase" }}>
          Doorway · 2.0 m
        </text>
