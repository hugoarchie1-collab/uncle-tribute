...
export const ReturningVisitorChip = () => {
  ...
  return (
    <span
      role="status"
      aria-live="polite"
      className="hidden md:inline-flex items-center font-sans text-[13px] 3xl:text-[16px] 4xl:text-[19px] tracking-[0.02em] text-ink/55 animate-[fadeIn_0.45s_ease-out]"
    >
