...
export const ConsentBanner = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1400px] 2xl:max-w-[1600px] 3xl:max-w-[92vw] 4xl:max-w-[94vw] px-4 sm:px-6 md:px-8 lg:px-12 pt-4 md:pt-5 pb-safe-4 flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
