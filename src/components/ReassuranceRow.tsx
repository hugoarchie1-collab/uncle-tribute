...
export const ReassuranceRow = () => (
  <div className="grid grid-cols-1 min-[400px]:grid-cols-3 gap-4">
    ...
    <div className="flex flex-col gap-1.5">
      ...
      <Link to="/legal#returns" className={cn(META, "underline underline-offset-4 hover:text-ink transition-colors")}>
    ...
    <div className="flex flex-col gap-1.5">
      ...
      <Link to="/contact#faq" className={cn(META, "underline underline-offset-4 hover:text-ink transition-colors")}>
