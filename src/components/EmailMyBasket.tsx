    ...
    <div className="mt-10 pt-8 border-t border-line">
      {!open && status !== "success" && (
        <button
          ...
          className="font-sans text-[11px] font-bold tracking-[0.28em] uppercase text-ink/55 hover:text-accent transition-colors bg-transparent border-0 p-0 cursor-pointer"
        >
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <button
                ...
                className="inline-flex items-center bg-ink text-bg px-6 py-3 font-sans text-[10px] font-bold tracking-[0.22em] uppercase rounded-full hover:bg-accent hover:text-ink transition-colors disabled:opacity-60"
              >
              ...
              <button
                ...
                className="font-sans text-[11px] tracking-[0.22em] uppercase text-ink/50 hover:text-ink transition-colors bg-transparent border-0 p-0 cursor-pointer"
              >
                Cancel
              </button>
            </div>
