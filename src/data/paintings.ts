...
export interface Collection {
   ...
   *
   * Save the file at e.g. /public/img/scenes/habundia.jpg?v=3 and reference it as
   * "/img/scenes/habundia.jpg?v=3".
   */
...
export const COLLECTIONS: Collection[] = [
  {
    ...
    backdropImage: "/img/scenes/habundia.jpg?v=3",
  },
  {
    id: "genesis",
    ...
    backdropImage: "/img/scenes/genesis.jpg?v=3",
  },
  {
    id: "born-in-the-sky",
    ...
    backdropImage: "/img/scenes/born-in-the-sky.jpg?v=3",
  },
];
