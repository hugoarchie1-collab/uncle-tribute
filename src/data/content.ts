// =============================================================================
// SITE CONTENT — Welcome page + About page text
// =============================================================================
// All editable text for the static pages lives here. Edit in quotes.
// Use [TBD] for anything you'll fill in later.
// =============================================================================
...
export const WELCOME = {
  openingQuote:
    "So here we are on Earth — orbiting a Sun Star at about 67,062 miles an hour.",
  openingAttribution: "Stephen Meakin",
  ...
  bio: [
    "Welcome to The Art of Mandala with internationally renowned Mandala Artist and Designer Stephen Meakin. Stephen Meakin — SEM — was a North European artist specialising in geometric paintings and mandala art. English-born, he explored ideas about abstract pattern as visual medicine, working across the traditions of oculi, mandala, sigil and yantra. His signature aesthetic is beautiful and powerful — mandala art paintings of such ethereal beauty that it is like viewing music in cross-section, with each mandala having its own number, rhythm, cadence and tone.",
    ...
    "Among his most celebrated commissions was the 3.6-metre Arista SunStar, created for entrepreneur Camilla Al Fayed for the Farmacy restaurant in Notting Hill, London. Subtle in its Egyptian theme, the blooming Blue Lotus detail from Hathor Temple at Dendera is held within a broad sun collar of painted-jewelled faience beads, set in gold and bronze around a burning sun disc.",
  ],
};

// -----------------------------------------------------------------------------
// ABOUT PAGE — the long-form biography
// -----------------------------------------------------------------------------
...
export const ABOUT = {
  ...
  earlyLife: [
    ...
    "Being unsure of his creative direction in 1990, he found a place to study for a degree in 3D design at Bournemouth. It was here, whilst researching ideas for a project, that he discovered a dusty old hardback full of ancient illuminated manuscripts from all over the world. The book contained loose-leaf illustrations of geometric pattern construction methods for both Arabic and Celtic patterns. On finding something “true” in those patterns, he began to imagine an abstract language that can be found in all cultures, and his passion for geometry was born.",
  ...
  legacy: [
    ...
    "He exhibited at the Majlis Gallery in Dubai's historic Bastakiya quarter, at Trinity Art Gallery in London and at Unique Arts Gallery in Brighton. In 2016, his 3.6-metre Arista SunStar was commissioned by Camilla Al Fayed for the Farmacy restaurant in Notting Hill, London. He designed the sacred geometry for the Sahara Force India Formula 1 car. He created the Tree of Wellbeing mandala — a fusion of a traditional Medicine Wheel design with a Celtic Tree of Life — distributed to children in 1,200 hospices and hospitals throughout the UK.",
    "In 2010 he founded TAGA — The Art of Geometry Academy — at Phoenix Place, Lewes.",
  ],

  academyQuote:
    "The Academy was founded by Stephen Meakin in 2010 and in the last 9 years over 250 students have attended classes from all over Europe to study on short courses in Sacred Geometry and Mandala Arts at TAGA. The Academy is currently one of the only schools in Europe where the ancient canons of the Geometer's Craft are shared openly to initiate students in the use of geometry as a symbolic language and as a contemplative art-form in the spiritual imagination.",
  ...
  studentsIntro: "To every student who passed through his door, he left these words:",
