...
export const WELCOME = {
  ...
  reminderLong: [
    "He said this not to disorientate or confuse us. But it's here as a reminder of the gift in free will — and how temporary every consequence truly is. Whatever suffering occurs in the mind, however heavy it feels, humans overcomplicate what life, in its simplicity, is actually asking of them.",
...
export const ABOUT = {
  ...
  // The Anegada blockquote sentence surfaced on the About page. Lifted VERBATIM
  // from anegada[0] above and kept here as its own field so the page renders the
  // FULL sentence from the single source — never a hardcoded, truncated copy.
  anegadaQuote:
    "At the exact moment I completed the circle, I felt something touch me that was inexplicable, totally beyond anything I had experienced before.",
