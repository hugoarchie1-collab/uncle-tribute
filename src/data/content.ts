...
export const TRIBUTE = {
  ...
  paragraphs: [
    ...
    "There was no one like Steve. He loved people but chose solitude. He felt absent in recent years, but at the same time present and engaging. He tried everything known. He tried every known religion to help fill the voids and discontentment and to expand his knowledge of the universe. He was so fascinated with the world around him. He lived by his heart, quite literally, and certainly gave it a run for its money.",
    "His moods, his passion, were intense; but when we think of Steve, we smile, we cry, we laugh, we get cross that we can't have him just a little longer — as the happy, contented person we knew he so deeply wanted to be. The caged bird sings, but the world longs to fly. Steve, we will love you forever.",
  ],
};
