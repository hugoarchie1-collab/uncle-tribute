...
**2026-06-15 — Drops model + provenance system + new wax-seal logo (built this session; UNCOMMITTED, awaiting Hugo's deploy OK; build/tsc/eslint green, sandbox tests pass).**
